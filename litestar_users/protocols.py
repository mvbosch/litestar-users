...
__all__ = [
    ...
    "SQLARoleT",
    "SQLAUserT",
    "SQLAlchemyOAuth2UserProtocol",
    "SQLAlchemyOAuth2UserRoleProtocol",
    "SQLAlchemyOAuthAccountProtocol",
    "SQLAlchemyRoleProtocol",
    "SQLAlchemyUserProtocol",
    "SQLAlchemyUserRoleProtocol",
    "UserRegisterT",
...
class SQLAlchemyUserRoleProtocol(SQLAlchemyUserProtocol, Protocol):  # pyright: ignore
    """SQLAlchemy user type with role support."""
...
class SQLAlchemyOAuth2UserProtocol(SQLAlchemyUserProtocol, Protocol):  # pyright: ignore
    """SQLAlchemy user type with OAuth2 account support."""
...
class SQLAlchemyOAuth2UserRoleProtocol(SQLAlchemyUserRoleProtocol, SQLAlchemyOAuth2UserProtocol, Protocol):  # pyright: ignore
    """SQLAlchemy user type with both role and OAuth2 account support."""
